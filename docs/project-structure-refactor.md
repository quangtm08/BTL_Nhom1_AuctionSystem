...
- **Lý do:** Client chỉ được phép gửi yêu cầu qua Socket. Việc để DB ở `common` là lỗ hổng bảo mật nghiêm trọng.
...
---
*Lưu ý: Logic nghiệp vụ không thay đổi, chỉ cấu trúc lại để hệ thống chuyên nghiệp và bảo mật hơn.*
