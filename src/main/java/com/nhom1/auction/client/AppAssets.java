...
public class AppAssets {
  ...
  public static void loadFonts() {
    ...
    try {
      ...
      InterRegular =
          Font.loadFont(AppAssets.class.getResourceAsStream("/assets/fonts/Inter-Regular.ttf"), 14);

      InterItalic =
          Font.loadFont(AppAssets.class.getResourceAsStream("/assets/fonts/Inter-Italic.ttf"), 14);
