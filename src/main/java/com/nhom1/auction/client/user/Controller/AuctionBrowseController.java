...
public class AuctionBrowseController {
    ...
    private Parent createAuctionCard(AuctionSummaryDto dto) {
        try {
            ...
            c.bind(dto, DisplayFormatters.auctionStatusLabel(dto.getStatus()), DisplayFormatters.money(resolveDisplayCurrentBid(dto)), DisplayFormatters.timeLeft(dto.getEndTime()), this::navigateToDetail);
