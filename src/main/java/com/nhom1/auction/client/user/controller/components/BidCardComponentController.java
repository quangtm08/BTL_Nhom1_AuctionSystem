...
public class BidCardComponentController {
    ...
    public void bind(BidWithAuctionDto dto, String yourBid, String currentBid, String timeLeft, Consumer<String> onRaiseBid) {
        ...
        statusBadgeLabel.setStyle(dto.isWinning() ? "" : "-fx-text-fill: #ff4d4d; -fx-background-color: #331a1a;");
