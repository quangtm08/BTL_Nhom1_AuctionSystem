...
public class CreateAuctionController {
  ...
  private void handleChoosePhotos() {
    ...
    Window window =
        uploadCountLabel.getScene() != null ? uploadCountLabel.getScene().getWindow() : null;
    ...
    String selectedNames =
        selectedFiles.stream().limit(2).map(File::getName).collect(Collectors.joining(", "));
  ...
  private void handlePublishListing() {
    String validationError =
        createAuctionService.validateInput(
            titleField.getText(),
