...
public class PaymentClientService extends BaseClientService {
    ...
    public CompletableFuture<PendingPaymentsResponse> listPendingPayments() {
        ...
        return send(new RequestMessage<>(MessageType.LIST_PENDING_PAYMENTS,
                new ListPendingPaymentsRequest(currentUser.getUserID())), PendingPaymentsResponse.class);
    }
    ...
    public CompletableFuture<PaymentHistoryResponse> listPaymentHistory() {
        ...
        return send(new RequestMessage<>(MessageType.LIST_PAYMENT_HISTORY,
                new ListPaymentHistoryRequest(currentUser.getUserID())), PaymentHistoryResponse.class);
    }
    ...
    public CompletableFuture<ProcessPaymentResponse> processPayment(String auctionId) {
        ...
        return send(new RequestMessage<>(MessageType.PROCESS_PAYMENT,
                new ProcessPaymentRequest(auctionId, currentUser.getUserID())), ProcessPaymentResponse.class);
    }
}
