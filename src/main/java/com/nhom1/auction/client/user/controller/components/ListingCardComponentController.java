...
public class ListingCardComponentController {
  ...
  public void bind(
    ...
    if (disableActions) {
      if (!editButton.getStyleClass().contains("btn-card-disabled"))
        editButton.getStyleClass().add("btn-card-disabled");
      if (!deleteButton.getStyleClass().contains("btn-card-disabled"))
        deleteButton.getStyleClass().add("btn-card-disabled");
