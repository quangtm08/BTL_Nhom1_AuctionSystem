...
public class WalletHandler {
    ...
    public void register(MessageRouter router) {
        router.register(MessageType.GET_WALLET, (requestId, payloadJson) -> {
            try {
        ...
        router.register(MessageType.DEPOSIT_MONEY, (requestId, payloadJson) -> {
            try {
        ...
        router.register(MessageType.WITHDRAW_MONEY, (requestId, payloadJson) -> {
            try {
