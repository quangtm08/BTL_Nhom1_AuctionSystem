        ...
        try {
            ...
            try {
                ...
                if (deletedAuctions == 0) {
                    throw new ValidationException("Auction was not deleted.");
                }
                if (deletedItems == 0) {
                    throw new ValidationException("Item was not deleted.");
                }
                connection.commit();
            ...
            throw new ValidationException("Delete transaction failed");
        }
    }
