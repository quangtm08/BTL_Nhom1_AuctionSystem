...
public class CommonDtoTest {
  ...
  private static final Class<?>[] DTO_CLASSES = {
    ...
    AdminApproveAuctionRequest.class,
    AdminAuctionListResponse.class,
    AdminCancelAuctionRequest.class,
    UpdateAuctionRequest.class,
    AutoBidConfigDetailResponse.class,
    DeleteAutoBidConfigRequest.class,
    GetAutoBidConfigRequest.class,
    AuctionDeletedEvent.class,
