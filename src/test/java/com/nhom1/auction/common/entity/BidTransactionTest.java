...
public class BidTransactionTest {
  ...
  public void testConstructor_NullAuctionId_Throws() {
    assertThrows(
        ...
        () ->
            new BidTransaction(null, UUID.randomUUID(), new BigDecimal("100.00"), BidType.MANUAL));
  }
  ...
  public void testConstructor_NullBidderId_Throws() {
    assertThrows(
        IllegalArgumentException.class,
        () ->
            new BidTransaction(UUID.randomUUID(), null, new BigDecimal("100.00"), BidType.MANUAL));
  }
  ...
  public void testConstructor_NullAmount_Throws() {
    assertThrows(
        IllegalArgumentException.class,
        () -> new BidTransaction(UUID.randomUUID(), UUID.randomUUID(), null, BidType.MANUAL));
  }
