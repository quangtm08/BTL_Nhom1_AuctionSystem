...
public class ItemFactoryTest {
  ...
  public void testCreateElectronics_Success() {
    ...
    // Act
    Item electronics =
        ItemFactory.createElectronics(
            "Gaming Laptop", "High performance laptop", ItemCondition.NEW);
    ...
    assertEquals(
        ItemCategory.ELECTRONICS, electronics.getCategory(), "The category should be ELECTRONICS");
  ...
  public void testCreateArt_Success() {
    ...
    // Act
    Item art =
        ItemFactory.createArt("Starry Night Replica", "Beautiful painting", ItemCondition.NEW);
  ...
  public void testCreateVehicle_Success() {
    ...
    // Act
    Item vehicle = ItemFactory.createVehicle("Honda Civic", "Used sedan", ItemCondition.USED);
