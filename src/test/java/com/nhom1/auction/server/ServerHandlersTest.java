...
public class ServerHandlersTest {
    ...
    public void testAuthHandler() throws Exception {
        ...
        // Test Login
        User mockUser = new User(UUID.randomUUID(), "alice", "alice@mail.com", "pass", UserRole.USER, LocalDateTime.now(), LocalDateTime.now());

        when(mockAuthService.login("alice", "pass")).thenReturn(mockUser);

        String loginReq = "{\"type\":\"LOGIN\",\"requestId\":\"r-1\",\"payload\":{\"identifier\":\"alice\",\"password\":\"pass\"}}";
        ...
        String regReq = "{\"type\":\"REGISTER\",\"requestId\":\"r-2\",\"payload\":{\"username\":\"bob\",\"email\":\"bob@mail.com\",\"password\":\"pass\"}}";
    ...
    public void testAdminHandler() throws Exception {
        ...
        ulr.setUsers(List.of(new UserSummaryDto("u-1", "user1", "u1@mail.com", UserRole.USER, LocalDateTime.now())));
        when(mockAdminService.getAllUsers("caller-1")).thenReturn(ulr);

        String listUsersReq = "{\"type\":\"ADMIN_LIST_USERS\",\"requestId\":\"r-1\",\"payload\":{\"callerId\":\"caller-1\"}}";
        ...
        String listAuctionsReq = "{\"type\":\"ADMIN_LIST_AUCTIONS\",\"requestId\":\"r-2\",\"payload\":{\"callerId\":\"caller-1\"}}";
        ...
        String delUserReq = "{\"type\":\"ADMIN_DELETE_USER\",\"requestId\":\"r-3\",\"payload\":{\"targetUserId\":\"target-1\",\"callerId\":\"caller-1\"}}";
        ...
        String cancelAucReq = "{\"type\":\"ADMIN_CANCEL_AUCTION\",\"requestId\":\"r-4\",\"payload\":{\"auctionId\":\"auc-1\",\"callerId\":\"caller-1\"}}";
    ...
    public void testAuctionHandler() throws Exception {
        ...
        String createReq = "{\"type\":\"CREATE_AUCTION\",\"requestId\":\"r-1\",\"payload\":{\"sellerId\":\"00000000-0000-0000-0000-000000000001\",\"name\":\"Table\",\"description\":\"Wood\",\"startingPrice\":\"10.0\",\"category\":\"ART\",\"condition\":\"NEW\",\"startTime\":\"2026-05-22T15:00:00\",\"endTime\":\"2026-05-25T15:00:00\"}}";
        String resp1 = router.handleRequest(createReq);
        assertTrue(resp1.contains("\"success\":true"));

        // List My Listings
        when(mockAuctionService.getMyListings("00000000-0000-0000-0000-000000000001")).thenReturn(Collections.emptyList());
        String listReq = "{\"type\":\"LIST_MY_LISTINGS\",\"requestId\":\"r-2\",\"payload\":{\"sellerId\":\"00000000-0000-0000-0000-000000000001\"}}";
        String resp2 = router.handleRequest(listReq);
        assertTrue(resp2.contains("\"success\":true"));

        // Delete Auction
        String delReq = "{\"type\":\"DELETE_AUCTION\",\"requestId\":\"r-3\",\"payload\":{\"sellerId\":\"00000000-0000-0000-0000-000000000001\",\"auctionId\":\"00000000-0000-0000-0000-000000000002\"}}";
        String resp3 = router.handleRequest(delReq);
        assertTrue(resp3.contains("\"success\":true"));
        verify(mockAuctionService).deleteAuction("00000000-0000-0000-0000-000000000001", "00000000-0000-0000-0000-000000000002");
    }
    ...
    public void testAutoBidHandler() throws Exception {
        ...
        String configReq = "{\"type\":\"AUTO_BID_CONFIG\",\"requestId\":\"r-1\",\"payload\":{\"auctionId\":\"auc-1\",\"bidderId\":\"user-1\",\"maxAmount\":100.0,\"increment\":5.0}}";
    ...
    public void testBidHandler() throws Exception {
        ...
        // Place Bid
        BidTransaction mockTx = new BidTransaction(
            bidTxId,
            auctionId,
            bidderId,
        ...
        when(mockBidService.placeBid(eq(bidderId), eq(auctionId), eq(new BigDecimal("150.0")), eq(BidType.MANUAL))).thenReturn(mockTx);

        String placeBidReq = String.format("{\"type\":\"PLACE_BID\",\"requestId\":\"r-1\",\"payload\":{\"auctionId\":\"%s\",\"bidderId\":\"%s\",\"bidAmount\":\"150.0\"}}",
                auctionId, bidderId);
        ...
        // Get Auction Detail
        AuctionDetailDto add = new AuctionDetailDto(
            auctionId.toString(),
        ...
        String getDetailReq = String.format("{\"type\":\"GET_AUCTION_DETAIL\",\"requestId\":\"r-3\",\"payload\":{\"auctionId\":\"%s\"}}", auctionId);
        ...
        String listMyBidsReq = String.format("{\"type\":\"LIST_MY_BIDS\",\"requestId\":\"r-4\",\"payload\":{\"bidderId\":\"%s\"}}", bidderId);
    ...
    public void testPaymentHandler() throws Exception {
        ...
        // Process Payment
        ProcessPaymentResponse ppr = new ProcessPaymentResponse("auc-1", new BigDecimal("100.0"), "SUCCESS", LocalDateTime.now());
        when(mockPaymentService.processPayment("auc-1", "user-1")).thenReturn(ppr);

        String processReq = "{\"type\":\"PROCESS_PAYMENT\",\"requestId\":\"r-1\",\"payload\":{\"auctionId\":\"auc-1\",\"bidderId\":\"user-1\"}}";
        ...
        String listPendingReq = "{\"type\":\"LIST_PENDING_PAYMENTS\",\"requestId\":\"r-2\",\"payload\":{\"bidderId\":\"user-1\"}}";
        ...
        String listHistReq = "{\"type\":\"LIST_PAYMENT_HISTORY\",\"requestId\":\"r-3\",\"payload\":{\"userId\":\"user-1\"}}";
    ...
    public void testClientHandlerAndRegistry() throws Exception {
        ...
        byte[] inputBytes = "{\"type\":\"LOGIN\",\"requestId\":\"r-1\",\"payload\":{\"identifier\":\"alice\",\"password\":\"pass\"}}\n".getBytes();
    ...
    public void testHandlersErrorPaths() throws Exception {
        ...
        when(mockAuthService.login(anyString(), anyString())).thenThrow(new IllegalArgumentException("Service login error"));
        String loginReq = "{\"type\":\"LOGIN\",\"requestId\":\"r-3\",\"payload\":{\"identifier\":\"alice\",\"password\":\"pass\"}}";
        ...
        when(mockAuthService.register(anyString(), anyString(), anyString())).thenThrow(new IllegalArgumentException("Service register error"));
        String regReq = "{\"type\":\"REGISTER\",\"requestId\":\"r-4\",\"payload\":{\"username\":\"bob\",\"email\":\"bob@mail.com\",\"password\":\"pass\"}}";
        String regResp = router.handleRequest(regReq);
        ...
        when(mockAdminService.getAllUsers(anyString())).thenThrow(new IllegalArgumentException("Admin users error"));
        String listUsersReq = "{\"type\":\"ADMIN_LIST_USERS\",\"requestId\":\"r-5\",\"payload\":{\"callerId\":\"caller-1\"}}";
        ...
        when(mockAdminService.getAllAuctions(anyString())).thenThrow(new IllegalArgumentException("Admin auctions error"));
        String listAuctionsReq = "{\"type\":\"ADMIN_LIST_AUCTIONS\",\"requestId\":\"r-6\",\"payload\":{\"callerId\":\"caller-1\"}}";
        ...
        when(mockAdminService.deleteUser(anyString(), anyString())).thenThrow(new IllegalArgumentException("Admin delete user error"));
        String delUserReq = "{\"type\":\"ADMIN_DELETE_USER\",\"requestId\":\"r-7\",\"payload\":{\"targetUserId\":\"target-1\",\"callerId\":\"caller-1\"}}";
        ...
        when(mockAdminService.cancelAuction(anyString(), anyString())).thenThrow(new IllegalArgumentException("Admin cancel error"));
        String cancelAucReq = "{\"type\":\"ADMIN_CANCEL_AUCTION\",\"requestId\":\"r-8\",\"payload\":{\"auctionId\":\"auc-1\",\"callerId\":\"caller-1\"}}";
        ...
        when(mockAuctionService.createAuction(anyString(), any())).thenThrow(new IllegalArgumentException("Create auction error"));
        String createReq = "{\"type\":\"CREATE_AUCTION\",\"requestId\":\"r-9\",\"payload\":{\"sellerId\":\"00000000-0000-0000-0000-000000000001\",\"name\":\"Table\",\"description\":\"Wood\",\"startingPrice\":\"10.0\",\"category\":\"ART\",\"condition\":\"NEW\",\"startTime\":\"2026-05-22T15:00:00\",\"endTime\":\"2026-05-25T15:00:00\"}}";
        ...
        when(mockAuctionService.getMyListings(anyString())).thenThrow(new IllegalArgumentException("My listings error"));
        String listReq = "{\"type\":\"LIST_MY_LISTINGS\",\"requestId\":\"r-10\",\"payload\":{\"sellerId\":\"seller-1\"}}";
        ...
        doThrow(new IllegalArgumentException("Delete auction error")).when(mockAuctionService).deleteAuction(anyString(), anyString());
        String delReq = "{\"type\":\"DELETE_AUCTION\",\"requestId\":\"r-11\",\"payload\":{\"sellerId\":\"seller-1\",\"auctionId\":\"auc-1\"}}";
        ...
        when(mockAutoBidService.saveConfig(any())).thenThrow(new IllegalArgumentException("Auto bid config error"));
        String configReq = "{\"type\":\"AUTO_BID_CONFIG\",\"requestId\":\"r-12\",\"payload\":{\"auctionId\":\"auc-1\",\"bidderId\":\"user-1\",\"maxAmount\":100.0,\"increment\":5.0}}";
        ...
        when(mockBidService.placeBid(any(), any(), any(), any())).thenThrow(new com.nhom1.auction.common.exception.ValidationException("Place bid error"));
        String placeBidReq = "{\"type\":\"PLACE_BID\",\"requestId\":\"r-13\",\"payload\":{\"auctionId\":\"" + UUID.randomUUID() + "\",\"bidderId\":\"" + UUID.randomUUID() + "\",\"bidAmount\":\"150.0\"}}";
        String placeBidResp = router.handleRequest(placeBidReq);
        assertTrue(placeBidResp.contains("Place bid error"));

        // List Auctions Service Exception
        when(mockBidService.listAllAuctions()).thenThrow(new IllegalArgumentException("List auctions error"));
        ...
        when(mockBidService.getAuctionDetail(any())).thenThrow(new com.nhom1.auction.common.exception.ValidationException("Get auction detail error"));
        String detailReq = "{\"type\":\"GET_AUCTION_DETAIL\",\"requestId\":\"r-15\",\"payload\":{\"auctionId\":\"" + UUID.randomUUID() + "\"}}";
        ...
        when(mockBidService.getMyBids(any())).thenThrow(new com.nhom1.auction.common.exception.ValidationException("List my bids error"));
        String myBidsReq = "{\"type\":\"LIST_MY_BIDS\",\"requestId\":\"r-16\",\"payload\":{\"bidderId\":\"" + UUID.randomUUID() + "\"}}";
        ...
        when(mockPaymentService.processPayment(anyString(), anyString())).thenThrow(new IllegalArgumentException("Process payment error"));
        String processReq = "{\"type\":\"PROCESS_PAYMENT\",\"requestId\":\"r-17\",\"payload\":{\"auctionId\":\"auc-1\",\"bidderId\":\"user-1\"}}";
        ...
        when(mockPaymentService.listPendingPayments(anyString())).thenThrow(new IllegalArgumentException("Pending payments error"));
        String pendingReq = "{\"type\":\"LIST_PENDING_PAYMENTS\",\"requestId\":\"r-18\",\"payload\":{\"bidderId\":\"user-1\"}}";
        ...
        when(mockPaymentService.listPaymentHistory(anyString())).thenThrow(new IllegalArgumentException("Payment history error"));
        String histReq = "{\"type\":\"LIST_PAYMENT_HISTORY\",\"requestId\":\"r-19\",\"payload\":{\"userId\":\"user-1\"}}";
    ...
    public void testMessageRouterEdgeCases() {
        ...
        try (org.mockito.MockedStatic<com.nhom1.auction.common.utils.JsonUtil> mockedJsonUtil = mockStatic(com.nhom1.auction.common.utils.JsonUtil.class)) {
            mockedJsonUtil.when(() -> com.nhom1.auction.common.utils.JsonUtil.toJson(any()))
    ...
    public void testClientHandlerIOExceptionOnRead() throws Exception {
        ...
        when(is.read(any(), anyInt(), anyInt())).thenThrow(new IOException("Simulated read IOException"));
        when(mockSocket.getInputStream()).thenReturn(is);
