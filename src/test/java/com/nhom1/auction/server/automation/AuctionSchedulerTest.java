...
public class AuctionSchedulerTest {
    ...
    public void testStartStopAndSafeTick() throws Exception {
        ...
        try {
            ...
            org.junit.jupiter.api.Assertions.assertTrue(output1.contains("AuctionScheduler tick failed: DB offline"));
            ...
            org.junit.jupiter.api.Assertions.assertFalse(output2.contains("AuctionScheduler tick failed"));
            ...
            org.junit.jupiter.api.Assertions.assertTrue(output4.contains("AuctionScheduler tick failed: DB offline again"));
        } finally {
