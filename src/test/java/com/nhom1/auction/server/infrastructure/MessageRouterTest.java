...
public class MessageRouterTest {
  ...
  @Mock private MessageRouteAction mockAction;
  ...
  @Test
  public void testHandleRequest_ValidJsonWithRegisteredType_RoutesToHandlerReturnsResponse()
      throws Exception {
    ...
    when(mockAction.execute("123", "{\"username\":\"user\"}"))
        .thenReturn((ResponseMessage) response);
