...
public class ServerHandlersAdditionalTest {
    ...
    public void testAdminHandlerAdditional() {
        ...
        String listAuctionsNull = "{\"type\":\"ADMIN_LIST_AUCTIONS\",\"requestId\":\"r-2\",\"payload\":null}";
        ...
        String deleteUserNull = "{\"type\":\"ADMIN_DELETE_USER\",\"requestId\":\"r-3\",\"payload\":null}";
        String deleteUserResp = router.handleRequest(deleteUserNull);
        assertTrue(deleteUserResp.contains("Missing delete user payload."));

        String cancelAuctionNull = "{\"type\":\"ADMIN_CANCEL_AUCTION\",\"requestId\":\"r-4\",\"payload\":null}";
        ...
        String malformedJson2 = "{\"type\":\"ADMIN_LIST_AUCTIONS\",\"requestId\":\"r-6\",\"payload\":[]}";
        ...
        String malformedJson4 = "{\"type\":\"ADMIN_CANCEL_AUCTION\",\"requestId\":\"r-8\",\"payload\":[]}";
    ...
    public void testBidHandlerAdditional() {
        ...
        String placeBidBadUUID = "{\"type\":\"PLACE_BID\",\"requestId\":\"r-1\",\"payload\":{\"auctionId\":\"bad-uuid\",\"bidderId\":\"bad-uuid\",\"bidAmount\":10.0}}";
        ...
        String getDetailBadUUID = "{\"type\":\"GET_AUCTION_DETAIL\",\"requestId\":\"r-2\",\"payload\":{\"auctionId\":\"bad-uuid\"}}";
        ...
        String listMyBidsBadUUID = "{\"type\":\"LIST_MY_BIDS\",\"requestId\":\"r-3\",\"payload\":{\"bidderId\":\"bad-uuid\"}}";
        ...
        String getDetailMalformed = "{\"type\":\"GET_AUCTION_DETAIL\",\"requestId\":\"r-5\",\"payload\":[]}";
        assertTrue(router.handleRequest(getDetailMalformed).contains("Invalid GET_AUCTION_DETAIL payload"));
    ...
    public void testPaymentHandlerAdditional() {
        ...
        String processPaymentNull = "{\"type\":\"PROCESS_PAYMENT\",\"requestId\":\"r-1\",\"payload\":null}";
        assertTrue(router.handleRequest(processPaymentNull).contains("Missing process payment payload."));

        String listPendingNull = "{\"type\":\"LIST_PENDING_PAYMENTS\",\"requestId\":\"r-2\",\"payload\":null}";
        assertTrue(router.handleRequest(listPendingNull).contains("Missing pending payments payload."));

        String paymentHistoryNull = "{\"type\":\"LIST_PAYMENT_HISTORY\",\"requestId\":\"r-3\",\"payload\":null}";
        assertTrue(router.handleRequest(paymentHistoryNull).contains("Missing payment history payload."));
        ...
        String listPendingMalformed = "{\"type\":\"LIST_PENDING_PAYMENTS\",\"requestId\":\"r-5\",\"payload\":[]}";
        assertTrue(router.handleRequest(listPendingMalformed).contains("Invalid pending payments JSON"));

        String historyMalformed = "{\"type\":\"LIST_PAYMENT_HISTORY\",\"requestId\":\"r-6\",\"payload\":[]}";
    ...
    public void testAuctionHandlerAdditional() {
        ...
        // 1. Malformed JSON (use JSON arrays for CREATE_AUCTION and omit payload for others to trigger null argument exception in JsonUtil)
    ...
    public void testNotificationServiceAdditional() {
        ...
        try (MockedStatic<JsonUtil> mockedJsonUtil = mockStatic(JsonUtil.class)) {
            mockedJsonUtil.when(() -> JsonUtil.toJson(any())).thenThrow(new RuntimeException("Serialization failure"));
